...
REQUIREMENTS=['future', 'openpathsampling', 'mdtraj', 'contact_map', 'numpy']
...
PACKAGES=['binding_md', 'binding_md.tests']
...
if __name__ == "__main__":
    write_version_py(os.path.join('binding_md', 'version.py'))
    setup(
        name="binding_md",
        ...
        version=PACKAGE_VERSION,
        license="MIT",
        url="http://github.com/dwhswenson/binding_md",
        packages=PACKAGES,
        package_dir={p: '/'.join(p.split('.')) for p in PACKAGES},
        package_data={'binding_md': ['tests/*pdb']},
        ext_modules=[],
        scripts=[],
