...
def write_version_py(filename='binding_md/version.py'):
    cnt = """
...
def buildKeywordDictionary():
    ...
    setupKeywords["download_url"]      = "http://github.com/dwhswenson/binding_md"
    setupKeywords["packages"]          = ['binding_md',
                                          'binding_md.tests']
    setupKeywords["package_dir"]       = {
        'binding_md' : 'binding_md',
        'binding_md.tests' : 'binding_md/tests'
    }
    setupKeywords["data_files"]        = []
    setupKeywords["ext_modules"]       = []
    setupKeywords["platforms"]         = ["Linux", "Mac OS X", "Windows"]
    setupKeywords["description"]       = "MDTraj-based contact maps"
    setupKeywords["requires"]          = ["mdtraj", "nose", "contact_map",
                                          "openpathsampling"]
